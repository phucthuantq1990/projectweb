	...
	<div class="container theme-showcase" role="main"
		...
		<div id="listaccounts">
			<fieldset>
				...
				<form action="changepasswordUser" id="mofifyPasswordForm"
					method="post"  name ="mofidyForm">
					<div class="row modal-body">
						<div class="col-md-6">
							 <div id="idLoginField">  <label><span style="color: red">* </span>Current
								Password:</label> <input id="inputCurrentPassword" type="password" name="currentPassword"
								class="form-control" required ="required"  /></div>
								<label id ="validateIdLogin" class ="validate"></label><br>
								<div id="FullNameField"><label><span style="color: red">* </span>New
								Password:</label> <input id ="inputNewPassword" type="password" name="newPassword" class="form-control"
					...
					<button type="submit" class="btn btn-info" id="modifybtn">
							<span
								...
								id="btnmodifyi"></span> <span id="btnmodifycontent">Change</span>
						</button>
					</div>
					</div>
				</div></div></form>
